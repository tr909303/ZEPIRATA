...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const diaDeJogoButton = document.getElementById('diaDeJogoButton');
  ...
  let hls = null;
  let dash = null;
  let currentChannelUrl = Object.values(channels)[0]; // Set the default channel URL
  ...
  function init() {
    ...
    playChannel(currentChannelUrl); // Play the default channel
